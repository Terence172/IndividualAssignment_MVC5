...
namespace IndividualAssignment_MVC5.Controllers
{
    public class EmailController : Controller
    {
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style='padding: 20px;'>
                                                                                            ...
                                                                                            <p style='margin-top: 0;'>FYP 1 System by Terence Loorthanathan</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
        ...
        // POST: Email/SendCredentials
        [HttpPost]
        public ActionResult SendCredentialsStudent(string userName, string password, string userEmail, string user_firstname, string user_lastname)
        {
            // Sender's email credentials
            string senderEmail = "terenceloorthanathan17@gmail.com"; // Replace with your Gmail address
            string senderPassword = "rzmvuyyascgfmzle"; // Replace with your Gmail password
            ...
            mail.Subject = "Welcome to FYP1 System - Student";
            mail.Body = $@"
                                                                        ...
                                                                        <td class='column' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px none #000000; border-bottom: 0px none #000000; background-color: transparent;' valign='top'>
                                                                            <table align='center' border='0' cellpadding='0' cellspacing='0' class='icons-inner' role='presentation' style='mso-table-lspace: 0pt; mso-table-rspace: 0pt; margin: 0 auto;' width='100%'>
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style='padding: 20px; text-align: center;'>
                                                                                            <h3 style='text-align: center;'>Hello, {user_firstname} {user_lastname}! </h3>
                                                                                            <p style='text-align: center;'>Welcome to FYP1 System</p>
                                                                                            <p style='text-align: center;'>Your Credentials to Login into the System are as follows:</p>
                                                                                            <p style='text-align: center;'>Username: {userName}</p>
                                                                                            <p style='text-align: center;'>Password: {password}</p>
            ...
            return RedirectToAction("Index", "students"); // Redirect to the desired action after sending the email
        }
